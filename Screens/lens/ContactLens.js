...
const ContactLens = () => {
 ...
 const [total,setTotal] =useState(0)
            ...
            setErrors("B.C.  is neccessary")
              ...
              setErrors("DIA  is neccessary")
                  ...
                  setErrors(" Purchase Price is neccessary")
                    ...
                    setErrors(" Sales Price is neccessary")
                    }
  ...
  .then(() => {
      ...
      setPdate("");setSup_comp_name("");setAddress("");
      setLensCompName("");setLensProdName("");setBc("");setDia("");setSph("");
      setCyl("");setAxis();setPair("");setTotal(0);setSale("");setPurchase("");
...
<TextInput  style={{...Styles.testInput,color:COLORS.black}} 
 ...
 <View style={Styles.twoColoumnView}>
    <TextInput placeholder='B.C.' style={Styles.twoColoumnText} keyboardType='numeric'
    value={bc} onChangeText={(value)=>setBc(value)} />
